            ...
            <div class="menu flex flex-col grow gap-0.5" data-menu="true" data-menu-accordion-expand-all="false" id="sidebar_menu">
                ...
                <div class="menu-item <?= menuShow(['order-table.php','brand-table.php','category-table.php','product-table.php', 'coupons-table.php','cart-table.php','user-table.php','shipping-table.php','uploads.php',]) ?>" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                    ...
                    <div class="menu-accordion gap-0.5 ps-[10px] relative before:absolute before:start-[20px] before:top-0 before:bottom-0 before:border-s before:border-gray-200">
                        ...
                        <div class="menu-item">
                            <a href="nxt-pages/uploads.php" class="menu-link border border-transparent items-center grow hover:bg-secondary-active dark:hover:bg-coal-300 hover:rounded-lg gap-[14px] ps-[10px] pe-[10px] py-[8px] <?= menuActive('uploads.php') ?>">
                                <span class="menu-bullet flex w-[6px] -start-[3px] rtl:start-0 relative before:absolute before:top-0 before:size-[6px] before:rounded-full rtl:before:translate-x-1/2 before:-translate-y-1/2 <?= bulletActive('uploads.php') ?>"></span>
                                <span class="menu-title text-2sm">Uploads</span>
                            </a>
                        </div>
                    </div>
                </div>
