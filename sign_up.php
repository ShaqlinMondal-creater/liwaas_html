...
<body class="min-h-screen gradient-bg">
    ...
    <nav class="sticky top-0 z-50 bg-white/80 backdrop-blur px-4 py-3 shadow-md ring-1 ring-gray-200">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <a href="signin.html" class="text-gray-800 hover:text-indigo-600 transition">Sign In</a>
            </div>
        </div>
    </nav>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div class="mx-auto h-20 w-20 bg-white/20 rounded-full flex items-center justify-center mb-6">
                    <svg class="h-10 w-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                    </svg>
                </div>
                <h2 class="text-3xl font-bold text-white mb-2">Create Account</h2>
                <p class="text-white/80">Join Liwaas and start your fashion journey</p>
            </div>
            ...
            <div class="glass-effect rounded-2xl p-8 shadow-2xl">
                <form class="space-y-6" action="#" method="POST" id="signupForm">
                    ...
                    <div>
                        ...
                        <div id="phoneError" class="text-red-300 text-sm mt-1 hidden">Please enter a valid Indian mobile number (10 digits starting with 6-9)</div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="terms" class="ml-2 block text-sm text-white/80">
                            I agree to the <a href="terms.html" class="text-white hover:text-white/80 underline">Terms and Conditions</a> 
                            and <a href="privacy.html" class="text-white hover:text-white/80 underline">Privacy Policy</a>
                        </label>
                    </div>
                ...
                <div class="text-center mt-6">
                    <p class="text-white/80">
                        ...
                        <a href="signin.html" class="font-medium text-white hover:text-white/80 transition-colors">Sign in here</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function validateIndianMobile() {
            ...
            if (phone && !indianMobileRegex.test(cleanPhone)) {
