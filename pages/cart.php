        ...
        <div class="lg:w-96">
          <div class="sticky top-20 bg-white rounded-lg shadow-lg border border-gray-200 p-6 space-y-4">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
              ...
              <button id="checkoutBtn" class="grad-btn w-full py-3 px-4 text-white font-medium rounded-lg hover:bg-[#c7aa28] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                Proceed to Checkout
              </button>
