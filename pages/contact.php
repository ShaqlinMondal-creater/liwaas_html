...
<section class="relative bg-gradient-to-br from-black via-orange-900 to-orange-400 text-white py-20">
    ...
    <div class="relative max-w-7xl mx-auto px-4 text-center">
        ...
        <p class="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">We'd love to hear from you. Get in touch with our
            team.</p>
    </div>
</section>
        ...
        <div class="prose prose-lg max-w-none">
            ...
            <div class="mb-8 p-6 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                ...
                <p class="text-blue-700">
                    Have questions about your order, shipping, returns, or products? Our support team is happy to assist
                    you.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p class="text-gray-600 mb-2"><strong>Phone:</strong> +91-XXXXXXXXXX</p>
                    <p class="text-gray-600">Available Monday to Saturday, 10:00 AM – 6:00 PM IST.</p>
                </div>

                <div class="bg-gray-50 p-6 rounded-lg">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Business Address</h3>
                    <p class="text-gray-600 mb-2"><strong>Address:</strong> India</p>
            ...
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Support Hours</h2>
            <p class="text-gray-600 mb-6 leading-relaxed">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Need Help Fast?</h2>
            <p class="text-gray-600 mb-6 leading-relaxed">
                Please include your order ID in all communications to help us assist you faster.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            <div class="text-center group">
                <div
                    class="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="text-center group">
                <div
                    class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="text-center group">
                <div
                    class="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
