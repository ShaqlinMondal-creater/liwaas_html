...
<div class="bg-white rounded-xl shadow p-4 mb-6">
    <h3 class="text-lg font-bold mb-4">Monthly Profit Chart</h3>
...
<div class="bg-white rounded-xl shadow p-4">
    ...
    <h3 class="text-lg font-bold mb-4">Monthly Profit Table</h3>
...
function loadProfitAnalytics() {
    ...
    .then(res => {
        ...
        data.month_wise_profit.forEach(item => {
            ...
            profitData.push(parseFloat(val.profit || 0));
            sellData.push(parseFloat(val.sell_value || 0));
            stockData.push(parseFloat(val.total_sales_stock_value || 0));
        ...
        renderProfitChart(labels, profitData, sellData, stockData);
...
// ===== RENDER CHART =====
function renderProfitChart(labels, profit, sell, stock) {
