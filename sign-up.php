...
<body class="relative min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('assets/brand/liwaas_logo_Black.jpg');">
    ...
    <div class="relative z-10 w-full min-h-screen flex items-center justify-center px-0 lg:px-16">
        <div class="w-full max-w-9xl grid grid-cols-1 lg:grid-cols-10 gap-1 mt-5 items-center">
            <!-- ================= LEFT SECTION (WIDE) ================= -->
                    ...
                    <form class="space-y-3 text-left" action="#" method="POST" id="signupForm">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-white/80">
                                I agree to the <a href="policies/terms-and-conditions" class="text-white hover:text-white/80 underline">Terms and Conditions</a> 
                                and <a href="policies/privacy-policy" class="text-white hover:text-white/80 underline">Privacy Policy</a>
                            </label>
                        </div>
